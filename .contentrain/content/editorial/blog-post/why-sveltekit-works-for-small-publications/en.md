...
SvelteKit is especially good when the site should feel like a publication first and an app second.

Server load functions keep data concerns clear while the UI stays light.
